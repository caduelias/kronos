        ...
        <div class="card-header">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <a  href="listar/treino-inativo" class="btn btn-dark float-right m-1"><i class="m-1 fas fa-list"></i><i class="m-1 fas fa-times"></i></a>
                </div>
                ...
                <?php
                    ...
                    echo "
                        <tr>
                            ...
                            <a href='javascript:inativar($codigo_treino)' class='btn btn-danger m-1'><i class='fas fa-times'></i></a>

<?php
    ...
    if ( $_POST ) 
    {
        ...
        if ( empty ( $codigo_exercicio ) ) 
        {
            ...
            (codigo_exercicio, Treino_codigo_treino, tipo, nome_exercicio, serie_repeticao,
            arquivo, descricao, duracao, peso_inicial)

            VALUES 

            (NULL, :codigo_treino, :tipo, :nome_exercicio, :serie_repeticao, :arquivo, :descricao,

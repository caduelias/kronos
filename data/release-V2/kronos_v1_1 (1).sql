...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22-Ago-2020 às 23:55
...
(38, 53, NULL, 'Leandro Felipe Antonio Ferreira', '1999-11-25', 'M', '234432561', '025.233.719-01', 'Hipertrofia', 'lleandrofelipeantonioferreira@sobraer.com.br', 1, '2020-08-20');
...
(6, 36, 15, '2020-08-22', 31, 74, 1.82, 22.34, 'Peso Ideal', 29.9, 51.88),
(7, 36, 16, '2020-08-22', 31, 81.5, 1.65, 29.94, 'Indefinida', 22.49, 63.17),
(8, 37, 17, '2020-08-22', 65, 111.11, 1.79, 34.68, 'Obesidade I', 40.08, 66.58);
...
(9, 19, 'Pilates', 0, 'Todo mundo já sabe o quanto é importante para a saúde a prática de exercícios físicos, porém não são todas as pessoas que apreciam realizar caminhada ou corrida e as atividades realizadas em academia.'),
...
--
ALTER TABLE `aluno_exercicio`
  MODIFY `codigo_aluno_exercicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=286;

--
-- AUTO_INCREMENT de tabela `aluno_modalidade`
--
ALTER TABLE `aluno_modalidade`
  MODIFY `codigo_aluno_modalidade` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
...
--
ALTER TABLE `modalidade`
  MODIFY `codigo_modalidade` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

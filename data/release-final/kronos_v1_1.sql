...
--
-- Host: 127.0.0.1
-- Tempo de geração: 31-Ago-2020 às 01:19
...
(7, 36, 16, '2020-08-20', 31, 81.5, 1.65, 29.94, 'Sobrepeso', 22.49, 63.17),
...
--
ALTER TABLE `aluno_modalidade`
  MODIFY `codigo_aluno_modalidade` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;

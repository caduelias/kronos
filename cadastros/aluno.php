        ...
        <div class="row">
          ...
          <div class="col-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control rg" name="rg" value="<?=$rg;?>" placeholder="Informe um RG"  required data-parsley-required-message="<i class='fas fa-times'></i> Campo RG é obrigatório!!">
            </div>
